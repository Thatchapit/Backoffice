    ...
    <div class="page-sidebar">
      <ul class="page-sidebar-menu  page-header-fixed ">
        ...
        <li class="active">
             ...
             <li class="nav-item active"> <a class="nav-link" href="join.php"> <i class="fa fa-handshake-o"></i> <span class="title">ร่วมเป็นส่วนหนึ่งกับเรา</span> </a></li>
      ...
      <div class="row wrapper border-bottom page-heading">
        <div class="col-lg-12">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active"> <a>ร่วมเป็นส่วนหนึ่งกับเรา</a> </li>
        ...
        ?>
                                <form id="form_validation" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            <textarea name="description" cols="30"  rows="15" class="form-control no-resize" required><?php echo $data['detail']; ?></textarea>
...
<script>
    ...
    console.log(mode);
            $("#form_validation").submit(function (e) {
                ...
                var url = "ajax/ajax_join.php"; // the script where you handle the form input.
