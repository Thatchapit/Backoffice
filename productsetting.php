...
<div class="page-container">
  ...
  <div class="page-content-wrapper animated fadeInRight">
      ...
      <div class="row wrapper border-bottom page-heading">
        <div class="col-lg-12">
          ...
          <ol class="breadcrumb">
            ...
            <li> <a>สินค้าและโปรโมชั่น</a> </li>
            <li class="active"> <strong><?php echo isset($_GET['id'])? "แก้ไข" : "เพิ่ม"  ?>สินค้าและโปรโมชั่น</strong> </li>
          </ol>
        </div>
    ...
    if(isset($_GET['id'])){
          ...
          $db->where ("id", $_GET['id']);
          $data = $db->getOne ("product_promotion");
        ?>
                <!-- Basic Validation -->
                                ...
                                <form id="form_validation" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="row clearfix" id="aniimated-thumbnials">
                                        <div class="col-sm-3">
                                            ...
                                            <a href="images/product/desktop/<?php echo $data['desktop_img']; ?>" class="thumbnailImage" data-sub-html="">
                                        <img  width="150" class="img-responsive thumbnail" src="images/product/desktop/<?php echo $data['desktop_img']; ?>">
                                        ...
                                        <div class="col-sm-3">
                                           <label class="form-label">ภาพปัจจุบัน Mobile</label><br/>
                                            <a href="images/product/mobile/<?php echo $data['mobile_img']; ?>" class="thumbnailImage" data-sub-html="">
                                        <img  width="150" class="img-responsive thumbnail" src="images/product/mobile/<?php echo $data['mobile_img']; ?>">
   ...
   <div class="col-sm-12"><br/></div>
                                                      ...
                                                      <div class="col-sm-3">
                                          <label class="form-label">ภาพสำหรับ Mobile</label><br/>
                                            <?php if($data['imageOther1'] != ""){ ?>
                                            <a href="images/product/other/<?php echo $data['imageOther1']; ?>" class="thumbnailImage" data-sub-html="">
                                        <img  width="300" class="img-responsive thumbnail" src="images/product/other/<?php echo $data['imageOther1']; ?>">
                                        <input type="hidden" name="old_other[]" value="<?php echo $data['imageOther1']; ?>">
                                    </a>
                                            <?php } ?>
                                        </div>
                                                        ...
                                                        <div class="col-sm-3">
                                            <label class="form-label">ภาพสำหรับ Mobile</label><br/>
                                            <?php if($data['imageOther2'] != ""){ ?>
                                            <a href="images/product/other/<?php echo $data['imageOther2']; ?>" class="thumbnailImage" data-sub-html="">
                                        <img  width="300" class="img-responsive thumbnail" src="images/product/other/<?php echo $data['imageOther2']; ?>">
                                        <input type="hidden" name="old_other[]" value="<?php echo $data['imageOther2']; ?>">
                                    </a>
                                            <?php } ?>
                                        </div>
                ...
                <div class="col-sm-3">
                                           <label class="form-label">ภาพสำหรับ Mobile</label><br/>
                                            <?php if($data['imageOther3'] != ""){ ?>
                                            <a href="images/product/other/<?php echo $data['imageOther3']; ?>" class="thumbnailImage" data-sub-html="">
                                        <img  width="300" class="img-responsive thumbnail" src="images/product/other/<?php echo $data['imageOther3']; ?>">
                                        <input type="hidden" name="old_other[]" value="<?php echo $data['imageOther3']; ?>">
                                    </a>
                                            <?php } ?>
                                        </div>
                                        ...
                                        <div class="col-sm-12"></div>
                                                          ...
                                                          <div class="col-sm-3">
                                                <label class="form-label">ภาพเพิ่มเติม 1</label><br/>
                                                <div class="fileinput fileinput-new" data-provides="fileinput">
                                                  <div class="fileinput-preview thumbnail" data-trigger="fileinput" style="width: 200px; height: 150px;"></div>
                                                  <div> <span class="btn btn-default btn-file"><span class="fileinput-new">Select image</span><span class="fileinput-exists">Change</span>
                                                    <input type="file" name="image_other[]">
                                                    </span> <a href="#" class="btn btn-default fileinput-exists" data-dismiss="fileinput">Remove</a> </div>
                                                </div>
                                          </div>
                                           <div class="col-sm-3">
                                           <label class="form-label">ภาพเพิ่มเติม 2</label><br/>
                                                <div class="fileinput fileinput-new" data-provides="fileinput">
                                                  <div class="fileinput-preview thumbnail" data-trigger="fileinput" style="width: 200px; height: 150px;"></div>
                                                  <div> <span class="btn btn-default btn-file"><span class="fileinput-new">Select image</span><span class="fileinput-exists">Change</span>
                                                    <input type="file" name="image_other[]">
                                           ...
                                           <div class="col-sm-3">
                                           <label class="form-label">ภาพเพิ่มเติม 3</label><br/>
                                                <div class="fileinput fileinput-new" data-provides="fileinput">
                                                  <div class="fileinput-preview thumbnail" data-trigger="fileinput" style="width: 200px; height: 150px;"></div>
                                                  <div> <span class="btn btn-default btn-file"><span class="fileinput-new">Select image</span><span class="fileinput-exists">Change</span>
                                                    <input type="file" name="image_other[]">
                                    ...
                                    <div class="row clearfix">
                                        <div class="col-sm-6">
                                            ...
                                            <label for="male">สินค้า</label>

                                            <input type="radio" value="1" name="type" id="female" class="with-gap">
                                            <label for="female" class="m-l-20">โปรโมชั่น</label>
                                        </div>';

                                                }else{
                                                          echo '<div class="form-group">
                                             
                                            <input type="radio" value="0" name="type" id="male" class="with-gap">
                                            <label for="male">สินค้า</label>

                                            <input type="radio" value="1" name="type" id="female"  checked="checked" class="with-gap">
                                            <label for="female" class="m-l-20">โปรโมชั่น</label>
                                        </div>';
                                                }
                                        ?>
