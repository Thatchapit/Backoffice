...
<title>Backoffice - เกี่ยวกับเรา</title>
<!-- dataTables -->
    ...
    <div class="page-sidebar">
      <ul class="page-sidebar-menu  page-header-fixed ">
        ...
        <li class="active">
             ...
             <li class="nav-item active"> <a class="nav-link" href="about.php"> <i class="fa fa-id-card-o"></i> <span class="title">เกี่ยวกับเรา</span> </a></li>
        ...
        ?>
                                <form id="form_validation" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group form-float">
                                      ...
                                      <label class="form-label">รายละเอียด2</label>
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            <textarea name="description2" cols="30" rows="5" class="form-control no-resize" required><?php echo $data['detail2']; ?></textarea>
                                          
                                        </div>
                                    </div>


                                      <label class="form-label">รายละเอียด3</label>
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            <textarea name="description3" cols="30" rows="5" class="form-control no-resize" required><?php echo $data['detail3']; ?></textarea>
...
<script>
    ...
    console.log(mode);
            $("#form_validation").submit(function (e) {
                ...
                var url = "ajax/ajax_about.php"; // the script where you handle the form input.
