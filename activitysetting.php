      ...
      <div class="row wrapper border-bottom page-heading">
        <div class="col-lg-12">
          ...
          <ol class="breadcrumb">
            ...
            <li> <a>กิจกรรม</a> </li>
            <li class="active"> <strong><?php echo isset($_GET['id'])? "แก้ไข" : "เพิ่ม"  ?>กิจกรรม</strong> </li>
          </ol>
        </div>
                                ...
                                <form id="form_validation" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="row clearfix" id="aniimated-thumbnials">
                                        <div class="col-sm-3">
                                            ...
                                            <a href="images/activity/desktop/<?php echo $data['desktop_img']; ?>" class="thumbnailImage" data-sub-html="">
                                        <img  width="150" class="img-responsive thumbnail" src="images/activity/desktop/<?php echo $data['desktop_img']; ?>">
                                        ...
                                        <div class="col-sm-3">
                                           <label class="form-label">ภาพปัจจุบัน Mobile</label><br/>
                                            <a href="images/activity/mobile/<?php echo $data['mobile_img']; ?>" class="thumbnailImage" data-sub-html="">
                                        <img  width="150" class="img-responsive thumbnail" src="images/activity/mobile/<?php echo $data['mobile_img']; ?>">
