    ...
    <div class="page-sidebar">
      <ul class="page-sidebar-menu  page-header-fixed ">
        ...
        <li class="active">
             ...
             <li class="nav-item active"> <a class="nav-link" href="contact.php"> <i class="fa fa-phone"></i> <span class="title">ติดต่อเรา</span> </a></li>      
      ...
      <div class="row wrapper border-bottom page-heading">
        <div class="col-lg-12">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active"> <a>ติดต่อเรา</a> </li>
      ...
      <div class="wrapper-content ">
        ...
        ?>
                                <form id="form_validation" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            <input name="email" class="form-control no-resize" value="<?php echo $data['email']; ?>"/>
                                    ...
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            <input name="line" class="form-control no-resize"  value="<?php echo $data['line']; ?>"/>
                                    ...
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            <input name="facebook" class="form-control no-resize"  value="<?php echo $data['facebook']; ?>"/>
                                    ...
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            <input name="phone" class="form-control no-resize"  value="<?php echo $data['phone']; ?>"/>
                                    ...
                                    <div class="form-group form-float">
                                        <div class="form-line">
                                            <input name="location" class="form-control no-resize"  value="<?php echo $data['location']; ?>"/>
...
<script>
    ...
    console.log(mode);
            $("#form_validation").submit(function (e) {
                ...
                var url = "ajax/ajax_contact.php"; // the script where you handle the form input.
