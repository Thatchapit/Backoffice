...
<title>Backoffice - Capital Plaza</title>
<!-- dataTables -->
...
<div class="page-container">
    ...
    <div class="page-sidebar">
      <ul class="page-sidebar-menu  page-header-fixed ">
        ...
        <li class="active">
             ...
             <li class="nav-item active"> <a class="nav-link" href="index.php"> <i class="fa fa-home"></i> <span class="title">Home</span> </a></li>
  ...
  <div class="page-content-wrapper animated fadeInRight">
    <div class="page-content" style="min-height:100vh; display:flex; justify-content: center; align-items: center;">
