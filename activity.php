    ...
    <div class="page-sidebar">
      <ul class="page-sidebar-menu  page-header-fixed ">
        ...
        <li class="active">
             ...
             <li class="nav-item active"> <a class="nav-link" href="activity.php"> <i class="fa fa-calendar"></i> <span class="title">กิจกรรม</span> </a></li>
      ...
      <div class="row wrapper border-bottom page-heading">
        <div class="col-lg-12">
          ...
          <ol class="breadcrumb">
            ...
            <li  class="active">  <strong><a>กิจกรรม</a> </strong> </li>
              ...
              <div class="ibox-content collapse in">
                <div class="widgets-container">
                   <div class="align-right">
                             <a href="activitysetting.php"><button type="button" class="btn btn-primary waves-effect">
                              สร้างหัวข้อใหม่
                             </button></a>
                            </div>
                            <br/>
                      ...
                      <thead>
                                    ...
                                    <tbody>
                                        ...
                                        $db->where('is_del',0);
                                            ...
                                            $results = $db->get('activity');
                                            for ($i=0; $i < count($results) ; $i++) { 
                                        ?>
                                
                                        <tr>
                                            <td><?php echo  $i+1 ?></td>
                                            <td><img src="images/activity/desktop/<?php echo $results[$i]['desktop_img'] ?>" alt="" height="150"></td>
                                            <td><?php echo $results[$i]['title'] ?></td>
                                            <td><?php echo $results[$i]['detail'] ?></td>
                                            <td><?php echo $results[$i]['type'] != 0 ? "" : "กิจกรรม"  ?></td>
                                            <td><?php echo $results[$i]['create_date'] ?></td>
                                            <td><a href="activitysetting.php?id=<?php echo  $results[$i]['id'] ?>"><button type="button" class="btn btn-warning waves-effect">แก้ไข</button></a>&nbsp;&nbsp;<button type="button" data-type="cancel" data-id="<?php echo  $results[$i]['id'] ?>" class=" del_btn btn btn-danger waves-effect">ลบ</button></td>
...
<script>
    ...
    swal({
        ...
        closeOnConfirm: false
                        ...
                        var url = "ajax/ajax_activity.php"; // the script where you handle the form input.
