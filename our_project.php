    ...
    <head>
        ...
        <title>Backoffice - Product Item Manage</title>
        <!-- dataTables -->
        ...
        <link rel="stylesheet" type="text/css" href="assets/selectize.js-master/dist/css/selectize.css" />
    ...
    <body class="page-header-fixed ">
            ...
            <div class="page-header-inner ">
                ...
                <div class="top-menu">
                    ...
                    <ul class="nav navbar-nav pull-right">
                        ...
                        <li class="dropdown dropdown-user"> <a data-close-others="true" data-hover="dropdown" data-toggle="dropdown" class="dropdown-toggle"
                                href="javascript:;">  <span class="username username-hide-on-mobile"></span> <i class="fa fa-angle-down"></i> </a>
        ...
        <li class="active">
             ...
             <ul class="sub-menu">
               <li class="nav-item"> <a class="nav-link" href="product_category_view.php"> <span class="title">Prdouct Category</span> </a> </li>
               <li class="nav-item active"> <a class="nav-link" href="product_item_view.php"> <span class="title">Prdouct Items</span> </a> </li>
            </ul>
           </li>
            ...
            <div class="page-content-wrapper animated fadeInRight">
                <div class="page-content">
                    <div class="row wrapper border-bottom page-heading">
                        <div class="col-lg-12">
                            <h2>Our Project Manage</h2>
                            <ol class="breadcrumb">
                                <li> <a href="index.php">Home</a> </li>
                                <li> <a href="our_project_view.php">Our Project</a> </li>
                                <li class="active"> <a>Our Project Manage</a> </li>
                    ...
                    <div class="wrapper-content ">
                        ...
                        <form id="form_validation" method="POST" enctype="multipart/form-data">
                                            ...
                                            <div class="col-lg-6">
                                                ...
                                                <label for="Title Th">Short - Title</label>
                                                <input class="form-control m-t-xxs" name="short_title_th" placeholder="ระบุ Short - Title" type="text">
                                            </div>
                                            <div class="form-group">
                                                <label for="Description">Short - Description</label>
                                                <textarea name="short_detail_th" class="form-control" cols="30" rows="10" placeholder="ระบุ Short - Description" ></textarea>
                                                </div>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div data-lang="th" data-toggle="modal" data-target=".modal-m" class="editor description_th_editor"></div>
                                                            </td>
                                            ...
                                            <div class="col-lg-6">
                                                <div class="ibox float-e-margins">
                                                    <div class="widgets-container">
                                                        ...
                                                        <hr>
                                                        <div class="form-group">
                                                <label for="Title En">Short - Title</label>
                                                <input class="form-control m-t-xxs" name="short_title_en" placeholder="Enter Short - Title" type="text">
                                            </div>
                                            <div class="form-group">
                                                <label for="Description">Short - Description</label>
                                                <textarea class="form-control" name="short_detail_en"  cols="30" rows="10" placeholder="Enter Short - Description"></textarea>
                                                </div>
                                                        <div class="form-group">
                                                        ...
                                                        <div class="form-group">
                                                            <label for="Description">Description</label>
                                                            <div data-lang="en" data-toggle="modal" data-target=".modal-m" class="editor description_en_editor"></div>
                                                ...
                                                <div class="ibox float-e-margins">
                                                    ...
                                                    <div class="ibox-content collapse in">
                                                                        ...
                                                                        <div class="col-12">
                                                                            ...
                                                                            <div class="col-md-4">
                                                                                <div class="fileinput fileinput-new" data-provides="fileinput">
                                                                                    <div class="fileinput-preview thumbnail" data-trigger="fileinput" style="width: 200px; height: 150px;"> <img data-src="holder.js/540x420" alt="..."></div>
                                                                                    <div> <span class="btn btn-default btn-file"><span class="fileinput-new">Select image</span>
                                                                                        <span class="fileinput-exists">Change</span>
                                                                                        <input type="file" name="image" id="image_banner" required>
                                                                            ...
                                                                            <label class="col-md-2 control-label">Image upload  <span style="color:red;">[SEO - tag]</label>
                                                                            <div class="col-md-4">
                                                                                <div class="fileinput fileinput-new" data-provides="fileinput">
                                                                                    <div class="fileinput-preview thumbnail" data-trigger="fileinput" style="width: 200px; height: 150px;"> <img data-src="holder.js/1200x628" alt="..."></div>
                                                                                    <div> <span class="btn btn-default btn-file"><span class="fileinput-new">Select image</span>
                                                                                        <span class="fileinput-exists">Change</span>
                                                                                        <input type="file" name="meta_image" id="image_meta" required>
                                                                                        </span> <a href="#" class="btn btn-default fileinput-exists"
                                                                                            data-dismiss="fileinput">Remove</a>                                                                                        </div>
                                                                                </div>
                                                                            </div>

                                                                            <label class="col-md-2 control-label">Image Thumbnail upload</label>
                                                                            <div class="col-md-4">
                                                                                <div class="fileinput fileinput-new" data-provides="fileinput">
                                                                                    <div class="fileinput-preview thumbnail" data-trigger="fileinput" style="width: 200px; height: 150px;"> <img data-src="holder.js/540x420" alt="..."></div>
                                                                                    <div> <span class="btn btn-default btn-file"><span class="fileinput-new">Select image</span>
                                                                                        <span class="fileinput-exists">Change</span>
                                                                                        <input type="file" name="thumbnail_image" id="image_banner" required>
                                                                                        </span> <a href="#" class="btn btn-default fileinput-exists"
                                                                                            data-dismiss="fileinput">Remove</a>                                                                                        </div>
                                                                                </div>
                                                                                <br/>
                                                        ...
                                                        <div class="col-md-12 " style="margin-top:15px;">
                                                            ...
                                                            <button type="clear " class="btn btn-warning m-t-xs bottom15-xs">Cancel</button>
                                                        </div>
                                                        </form>
                                                    </div>
                                                </div>
                    ...
                    <div class="modal fade modal-m" tabindex="-1" role="dialog">
                        <div class="modal-dialog " style="width: 55%">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="input-group col-md-12">
                                        ...
                                        <div class="note-editor  panel panel-default">
                                            <div class="btn-toolbar note-toolbar panel-heading" data-role="editor-toolbar" data-target="#editor">
                                                <div class="btn-group"> <a class="btn dropdown-toggle btn-default" data-toggle="dropdown" title="Font"><i class="fa fa-font"></i><b class="caret"></b></a>
                                                    <ul class="dropdown-menu">
                                                    </ul>
                                                </div>
                                                <div class="btn-group"> <a class="btn dropdown-toggle btn-default" data-toggle="dropdown" title="Font Size"><i class="fa fa-text-height"></i>&nbsp;<b class="caret"></b></a>
                                                    <ul class="dropdown-menu">
                                                        <li>
                                ...
                                <div class="modal-footer">
                                    <button type="button" class="btn btn-warning" data-dismiss="modal" style="margin-bottom: 0">Close</button>
                                    <button data-dismiss="modal" type="button" class="btn btn-primary aqua addDescription">Add Description</button>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        $(document).ready(function () {
                           ...
                           /* $("#image_banner").change(function () {
                                ...
                                if (typeof file === "undefined") {
                                    ...
                                    displayPreview(file, 540, 420, 250, "image_banner");
                                }
                            });
                            ...
                            function displayPreview(files, limit_width, limit_height, limit_size, type) {
                                ...
                                img.onload = function () {
                                    ...
                                    if (fileSize > limit_size || width != limit_width || height !=
                                        limit_height) {
...
*/
                            ...
                            $("#form_validation").submit(function (e) {
                                ...
                                var url = "ajax/ajax_product_item.php"; // the script where you handle the form input.
