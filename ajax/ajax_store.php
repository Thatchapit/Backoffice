<?php
    ...
    $TARGET_PATH_DESKTOP = "../images/store/desktop/";
    $TARGET_PATH_MOBILE = "../images/store/mobile/";
  ...
  echo count($_FILES['image_other']['name']);
        for ($i=0; $i < count($_FILES['image_other']['name']); $i++) { 
     $TARGET_PATH_OTHER = "../images/store/other/";
    ...
    if(isset($_FILES['image_mobile-file'])&& $_FILES['image_mobile-file']['name'] != ""){
        ...
        if($mode == "add"){
            if($imagename != ""){
                ...
                $editor->save( $image1, "../images/store/mobile/m_".$imagename);
