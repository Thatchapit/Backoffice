...
date_default_timezone_set("Asia/Bangkok");
    ...
    $TARGET_PATH_DESKTOP = "../images/activity/desktop/";
    $TARGET_PATH_MOBILE = "../images/activity/mobile/";
    $imagename = "";
    $image_mobile_name = "";
    ...
    if(isset($_FILES['image_mobile-file'])&& $_FILES['image_mobile-file']['name'] != ""){
        ...
        if($mode == "add"){
            if($imagename != ""){
                ...
                $editor->save( $image1, "../images/activity/mobile/m_".$imagename);
