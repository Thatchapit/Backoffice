      ...
      <div class="row wrapper border-bottom page-heading">
        <div class="col-lg-12">
          ...
          <ol class="breadcrumb">
            ...
            <li  class="active">  <strong><a>ข่าวสาร/ประชาสัมพันธ์</a> </strong> </li>
              ...
              <div class="ibox-content collapse in">
                <div class="widgets-container">
                   <div class="align-right">
                             <a href="newssetting.php"><button type="button" class="btn btn-primary waves-effect">
                              สร้างหัวข้อใหม่
                             </button></a>
                            </div>
                            <br/>
                    ...
                    <table id="example" class="table  responsive nowrap table-bordered" cellspacing="0" width="100%">
                      <thead>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td><?php echo  $i+1 ?></td>
                                            <td><img src="images/news/desktop/<?php echo $results[$i]['desktop_img'] ?>" alt="" height="150"></td>
                                            <td><?php echo $results[$i]['title'] ?></td>
                                            <td><?php echo $results[$i]['detail'] ?></td>
                                            <td><?php echo $results[$i]['type'] != 0 ? "ข่าวสาร" : "ประชาสัมพันธ์"  ?></td>
                                            <td><?php echo $results[$i]['create_date'] ?></td>
                                            <td><a href="newssetting.php?id=<?php echo  $results[$i]['id'] ?>"><button type="button" class="btn btn-warning waves-effect">แก้ไข</button></a>&nbsp;&nbsp;<button type="button" data-type="cancel" data-id="<?php echo  $results[$i]['id'] ?>" class=" del_btn btn btn-danger waves-effect">ลบ</button></td>
