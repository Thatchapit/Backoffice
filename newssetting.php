      ...
      <div class="row wrapper border-bottom page-heading">
        <div class="col-lg-12">
          ...
          <ol class="breadcrumb">
            ...
            <li> <a>ข่าวสาร/ประชาสัมพันธ์</a> </li>
            <li class="active"> <strong><?php echo isset($_GET['id'])? "แก้ไข" : "เพิ่ม"  ?>ข่าวสาร/ประชาสัมพันธ์</strong> </li>
          </ol>
        </div>
                                ...
                                <form id="form_validation" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="row clearfix" id="aniimated-thumbnials">
                                        <div class="col-sm-3">
                                            ...
                                            <a href="images/news/desktop/<?php echo $data['desktop_img']; ?>" class="thumbnailImage" data-sub-html="">
                                        <img  width="150" class="img-responsive thumbnail" src="images/news/desktop/<?php echo $data['desktop_img']; ?>">
                                        ...
                                        <div class="col-sm-3">
                                           <label class="form-label">ภาพปัจจุบัน Mobile</label><br/>
                                            <a href="images/news/mobile/<?php echo $data['mobile_img']; ?>" class="thumbnailImage" data-sub-html="">
                                        <img  width="150" class="img-responsive thumbnail" src="images/news/mobile/<?php echo $data['mobile_img']; ?>">
   ...
   <div class="col-sm-12"><br/></div> </div>
                                    ...
                                    <div class="row clearfix">
                                        <div class="col-sm-6">
                                            ...
                                            <label for="male">ข่าวสาร</label>

                                            <input type="radio" value="1" name="type" id="female" class="with-gap">
                                            <label for="female" class="m-l-20">ประชาสัมพันธ์</label>
                                        </div>';
...
<script>
    ...
    console.log(mode);
            $("#form_validation").submit(function (e) {
                ...
                var url = "ajax/ajax_news.php"; // the script where you handle the form input.
