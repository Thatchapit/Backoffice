    ...
    <div class="page-sidebar">
      <ul class="page-sidebar-menu  page-header-fixed ">
        ...
        <li class="active">
             ...
             <li class="nav-item active"> <a class="nav-link" href="news.php"> <i class="fa fa-file-text"></i> <span class="title">ข่าวสาร/ประชาสัมพันธ์</span> </a></li>
  ...
  <div class="page-content-wrapper animated fadeInRight">
      ...
      <div class="row wrapper border-bottom page-heading">
        <div class="col-lg-12">
          ...
          <ol class="breadcrumb">
            ...
            <li> <a>ร้านค้า</a> </li>
            <li class="active"> <strong><?php echo isset($_GET['id'])? "แก้ไข" : "เพิ่ม"  ?>ร้านค้า</strong> </li>
          </ol>
        </div>
                                ...
                                <form id="form_validation" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="row clearfix" id="aniimated-thumbnials">
                                        <div class="col-sm-3">
                                            ...
                                            <a href="images/store/desktop/<?php echo $data['desktop_img']; ?>" class="thumbnailImage" data-sub-html="">
                                        <img  width="150" class="img-responsive thumbnail" src="images/store/desktop/<?php echo $data['desktop_img']; ?>">
                                        ...
                                        <div class="col-sm-3">
                                           <label class="form-label">ภาพปัจจุบัน Mobile</label><br/>
                                            <a href="images/store/mobile/<?php echo $data['mobile_img']; ?>" class="thumbnailImage" data-sub-html="">
                                        <img  width="150" class="img-responsive thumbnail" src="images/store/mobile/<?php echo $data['mobile_img']; ?>">
   ...
   <div class="col-sm-12"><br/></div>
                                          ...
                                          <label class="form-label">ภาพสำหรับ Mobile</label><br/>
                                            ...
                                            <a href="images/store/other/<?php echo $data['imageOther1']; ?>" class="thumbnailImage" data-sub-html="">
                                        <img  width="300" class="img-responsive thumbnail" src="images/store/other/<?php echo $data['imageOther1']; ?>">
                                        <input type="hidden" name="old_other[]" value="<?php echo $data['imageOther1']; ?>">
                                            ...
                                            <a href="images/store/other/<?php echo $data['imageOther2']; ?>" class="thumbnailImage" data-sub-html="">
                                        <img  width="300" class="img-responsive thumbnail" src="images/store/other/<?php echo $data['imageOther2']; ?>">
                ...
                <div class="col-sm-3">
                                           <label class="form-label">ภาพสำหรับ Mobile</label><br/>
                                            ...
                                            <a href="images/store/other/<?php echo $data['imageOther3']; ?>" class="thumbnailImage" data-sub-html="">
                                        <img  width="300" class="img-responsive thumbnail" src="images/store/other/<?php echo $data['imageOther3']; ?>">
...
<script>
    ...
    console.log(mode);
            $("#form_validation").submit(function (e) {
                ...
                var url = "ajax/ajax_store.php"; // the script where you handle the form input.
